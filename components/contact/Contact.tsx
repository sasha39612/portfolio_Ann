...
const ContactComponent = ({ contactTitle, contactDescription, inputName, inputEmail, inputMessage, button }: ContactType) => {
      ...
      <div className={styles.contactInputBlock}>
        <div className={styles.contactInputContainer}>
          <div className={styles.inputStyle}>
            ...
            <input id="form-name" name="name" maxLength={50} size={20} autoComplete="name" type="text" placeholder={inputName.placeHolder} required />
          </div>
          <div className={styles.inputStyle}>
        ...
        <div className={styles.inputStyle}>
          ...
          <textarea id="form-message" name="message" placeholder={inputMessage.placeHolder} required />
        </div>
      </div>
      <ButtonComponent type="submit" background="black" className={styles.submitButton}>{button.text}</ButtonComponent>
    </form>
  )
}
