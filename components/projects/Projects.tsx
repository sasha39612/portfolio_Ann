...
const getButtonStyles = (buttonName: string, buttonTitle: string) => {
  const activeStyles =
    buttonName === buttonTitle ? styles.buttonTitleActive : '';
...
const Projects = ({
  ...
  const handlerOnclick = () => {
    setButtonName(() =>
      buttonName === buttonTitle[0] ? buttonTitle[1] : buttonTitle[0],
    );
  };
    ...
    <section>
      <div className={styles.buttonWrapper}>
        <button
          ...
          className={getButtonStyles(buttonName, buttonTitle[0])}
        >
          {buttonTitle[0]}
        </button>
        <button
          onClick={handlerOnclick}
          className={getButtonStyles(buttonName, buttonTitle[1])}
        >
          {buttonTitle[1]}
        </button>
      </div>
