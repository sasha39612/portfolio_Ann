...
const MobileHeader = ({ logoImage, menuManageImage, links, className }: HeaderPropsLinksMobileType) => {
    ...
    const modal = mounted
                ...
                <nav className={cn(styles.wrapper, className)}>
                    <div className={styles.LogoAndCloseWrapper}>
                        ...
                        <button
                            ...
                            onClick={onCloseMenu}
                        >
                            <ImageComponent {...menuManageImage?.[0]}
                                layout='fill'
                                objectFit='contain'
        ...
        <div className={cn(styles.LogoAndCloseWrapper, className)}>
            ...
            <button
                ...
                onClick={onOpenMenu}
            >
                <ImageComponent {...menuManageImage?.[2]}
                    layout='fill'
                    objectFit='contain'
                    className={styles.wrapperCloseImageMobile}
                />
